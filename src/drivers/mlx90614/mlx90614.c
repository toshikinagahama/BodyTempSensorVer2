...
float read_temp(const struct i2c_dt_spec *, uint8_t);
 ...
 * @return int
 */
int mlx90614_enter_sleep(const struct i2c_dt_spec *dev_i2c, const struct gpio_dt_spec *scl_gpio,
...
int mlx90614_exit_sleep(const struct i2c_dt_spec *dev_i2c, const struct gpio_dt_spec *scl_gpio,
                        const struct gpio_dt_spec *sda_gpio)
{
 ...
 * @return float
 */
float mlx90614_read_env_temp(const struct i2c_dt_spec *dev_i2c)
{
    return read_temp(dev_i2c, MLX90614_COMMAND_ENVIRONMENT_TEMPERATURE);
}
 ...
 * @return float
 */
float mlx90614_read_obj_temp(const struct i2c_dt_spec *dev_i2c)
{
    return read_temp(dev_i2c, MLX90614_COMMAND_OBJECT_TEMPERATURE);
}
 ...
 * @return float
 */
float read_temp(const struct i2c_dt_spec *dev_i2c, uint8_t reg)
{
